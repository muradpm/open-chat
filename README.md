...
<p align="center">
  An Open-Source AI Chatbot Built With Next.js, Convex, and the AI SDK.
</p>
...
This app ships with [Ollama](https://ollama.ai/) provider as the default. However, with the [AI SDK](https://sdk.vercel.ai/docs), you can switch LLM providers to [OpenAI](https://openai.com), [Anthropic](https://anthropic.com), [Cohere](https://cohere.com/), and [many more](https://sdk.vercel.ai/providers/ai-sdk-providers) with just a few lines of code.
